function calculateLoan(){
    ...
    document.getElementById("totalPrincipalOutput").innerHTML = `$${(Math.round(  totalMonthlyPayment  *100)/100).toFixed(2)}`
    document.getElementById("totalInterestOutput").innerHTML = `$${(Math.round(  loanAmount  *100)/100).toFixed(2)}`
    document.getElementById("totalCostOutput").innerHTML = `$${(Math.round( (loanAmount+totalMonthlyPayment)  *100)/100).toFixed(2)}`
